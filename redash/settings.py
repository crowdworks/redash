...
GOOGLE_GROUP_MEMBER_SYNC_ENABLED = os.environ.get("REDASH_GOOGLE_GROUP_MEMBER_SYNC_ENABLED")

def _parse_oauth_token(env_key):
    if not GOOGLE_ACCOUNT_CONNECT_OAUTH_SERVER_ENABLED:
        return None
    b64token = os.environ.get(env_key)
    if not b64token:
        return None
...
GOOGLE_ACCOUNT_CONNECT_OAUTH_TOKEN = _parse_oauth_token("REDASH_GOOGLE_ACCOUNT_CONNECT_OAUTH_TOKEN")
GOOGLE_ACCOUNT_CONNECT_OAUTH_ENABLED = GOOGLE_ACCOUNT_CONNECT_EMAIL and GOOGLE_ACCOUNT_CONNECT_OAUTH_TOKEN

EXPORT_GOOGLE_SPREADSHEET_OAUTH_TOKEN = _parse_oauth_token("REDASH_EXPORT_GOOGLE_SPREADSHEET_OAUTH_TOKEN")
EXPORT_GOOGLE_SPREADSHEET_EMAIL = os.environ.get("REDASH_EXPORT_GOOGLE_SPREADSHEET_EMAIL")
EXPORT_GOOGLE_SPREADSHEET_ENABLED = os.environ.get("REDASH_EXPORT_GOOGLE_SPREADSHEET_ENABLED") \
                                    and EXPORT_GOOGLE_SPREADSHEET_OAUTH_TOKEN and EXPORT_GOOGLE_SPREADSHEET_EMAIL
...
# crowdworks-extended
# Notify Slack when executing query failed
QUERY_ERROR_REPORT_SLACK_WEBHOOK_URL = os.environ.get("REDASH_QUERY_ERROR_REPORT_SLACK_WEBHOOK_URL", None)
QUERY_ERROR_REPORT_SLACK_CHANNEL = os.environ.get("REDASH_QUERY_ERROR_REPORT_SLACK_CHANNEL", None)
QUERY_ERROR_REPORT_SLACK_USERNAME = os.environ.get("REDASH_QUERY_ERROR_REPORT_SLACK_USERNAME", None)
QUERY_ERROR_REPORT_SLACK_ICON_EMOJI = os.environ.get("REDASH_QUERY_ERROR_REPORT_SLACK_ICON_EMOJI", None)

QUERY_ERROR_REPORT_ENABLED = QUERY_ERROR_REPORT_SLACK_WEBHOOK_URL and QUERY_ERROR_REPORT_SLACK_CHANNEL
